...
for (coln in 2:25)
  temp.data[,coln]<-a[,coln]-fit.lm$fitted.values
...
plot(elec.pca$scores[which(fit.kmeans8$cluster==1),], pch=16, col=1, xlim=c(-4,2.6), ylim=c(-2.5,2.5),
     main="K-means clustering (k=8)")
points(elec.pca$scores[which(fit.kmeans8$cluster==2),], pch=17, col=2, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==3),], pch=18, col=3, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==4),], pch=19, col=4, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==5),], pch=20, col=5, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==6),], pch=21, col=6, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==7),], pch=22, col=7, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans8$cluster==8),], pch=23, col=8, xlim=c(-2,2), ylim=c(-2,2))
...
plot(elec.pca$scores[which(fit.kmeans11$cluster==1),], pch=16, col=1, xlim=c(-4,2.6), ylim=c(-2.5,2.5),
     main="K-means clustering (k=11)")
points(elec.pca$scores[which(fit.kmeans11$cluster==2),], pch=17, col=2, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==3),], pch=18, col=3, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==4),], pch=19, col=4, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==5),], pch=20, col=5, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==6),], pch=21, col=6, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==7),], pch=22, col=7, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==8),], pch=23, col=8, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==9),], pch=24, col=9, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==10),], pch=25, col=3, xlim=c(-2,2), ylim=c(-2,2))
points(elec.pca$scores[which(fit.kmeans11$cluster==11),], pch=21, col=2, xlim=c(-2,2), ylim=c(-2,2))
...
x[is.na(x)] <- 0
sum(is.na(x))
# 데이터를 trainData와 testData로 샘플링한다.
set.seed(1234)
...
library(e1071)
for(i in 1:24)
  nBayes <-naiveBayes(x[,27:35],x[,1])
pred_bayes<-predict(nBayes, testData[,27:35])
testData[,24]
